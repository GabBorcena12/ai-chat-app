using AIChatApp.API.Models.Authentication;
...
namespace AIChatApp.API.Controllers.Authentication
{
    /// <summary>
    /// Exposes registration, sign-in, account profile, email confirmation, and two-factor authentication endpoints.
    /// Keep credential and token rules in Identity and authentication services; authenticated actions must prefer JWT claims over request identity fields.
    /// </summary>
    [ApiController]
    [Route("api/auth")]
