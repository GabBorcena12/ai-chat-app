...
{
    /// <summary>
    /// Adapts LLamaSharp's local interactive executor to the streaming LLM contract.
    /// Keep prompt construction, response cleanup, retries, and persistence outside this model-runtime adapter.
    /// </summary>
