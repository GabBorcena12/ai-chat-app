...
{
    /// <summary>
    /// Builds bounded model prompts from system instructions, managed knowledge, retrieved snippets, and recent chat history.
    /// This service selects context only; model execution and final response policy belong to the orchestrator.
    /// </summary>
    public class PromptBuilder : IPromptBuilder
    {
        ...
        private Task<string> LoadSystemContextAsync(string? _)
            => _assistantContentService.LoadPromptAsync(_assistantProfile.ProfileId, "SystemContext.json");
